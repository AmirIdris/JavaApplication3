                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ammount, javax.swing.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(71, 71, 71)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         try {
            ...
            String accont_number = account.getText();

            int account = Integer.parseInt(accont_number);

            String ammount = this.ammount.getText();
             if (accont_number.length() == 0 || ammount.length() == 0) {
                 JOptionPane.showMessageDialog(rootPane, "Please Fill The Form");
             } else {
                 double money = Double.parseDouble(ammount);
                 double result = bank.transfer(key, money, account);

                 if (result == 0.0) {
                     JOptionPane.showMessageDialog(rootPane, "Insufficient Balance");
                 } else {
                     JOptionPane.showMessageDialog(rootPane, "You Transferd " + result + " Birr");
                 }
             }
